...
import { StyleSheet, Text, View, StatusBar, Pressable,FlatList,TouchableOpacity,Image,Linking,ScrollView } from 'react-native';
import { Ionicons } from '@expo/vector-icons';

export default function D_PastRideDetails({navigation}) {
...
<View style={styles.container}>
    ...
    <View >
        ...
        <View style={{backgroundColor:'#F4F4F4',paddingVertical:12,borderWidth:0.5, borderColor:'#D9D9D9'}}>
            <Text style={{fontSize:14,fontWeight:600,color:'#6F6F6F',paddingHorizontal:'8%'}}>Passenger Info</Text>
        </View>
        <View style={{flexDirection:'row',paddingHorizontal:'8%',paddingVertical:'5%'}}>
                            <View style={{width:'80%',justifyContent:'center'}}>
                            <Text style={{fontWeight:500,fontSize:13,color:'#626262'}}>Sonam Wangyel</Text>
                            <Text style={{fontWeight:500,fontSize:11,color:'#969696'}}>Male</Text>
                            </View>
                            <View style={{justifyContent:'center',alignItems:'flex-end',width:'20%',flexDirection:'row'}}>
                            <Pressable
                                onPress={() => {
                    ...
                    <Text style={{fontWeight:500,fontSize:13,color:'#626262'}}>PickUp Note</Text>
                    <View style={{maxHeight:90}}>
                        <ScrollView>
                            <Text style={{fontSize:11,color:'#969696',lineHeight:20}}>
                            Thimphu Buddha Point, also known as the Kuensel Phodrang, offers breathtaking views of Thimphu Valley. Surrounded by lush hills, it's serene and spiritually captivating.
                            Thimphu Buddha Point, also known as the Kuensel Phodrang, offers breathtaking views of Thimphu Valley. Surrounded by lush hills, it's serene and spiritually captivating.
    ...
    <View style={{marginHorizontal:'8%'}}>
        <View style={{flexDirection:'row',marginTop:10}}>
            <View style={{width:'50%'}}>
                ...
                <Text style={{color:'#0F992E',fontWeight:500,fontSize:14}}>CASH</Text>
            </View>
            <View style={{width:'50%',alignItems:'flex-end'}}>
            <Text style={{color:'#8C8C8C',fontWeight:500,fontSize:14}}>Total Cost</Text>
                <Text style={{color:'#0F992E',fontWeight:500,fontSize:14}}>Nu. 400</Text>
            </View>
        </View>
    </View>
    </View>
