import {
  ...
  export default function Register({ navigation }) {
    ...
    // useEffect(() => {//testing the api to fetch data
    //     const fetchPassengers = async () => {
    //       try {
    //         const response = await axios.get(`${config.API_URL}/api/passengers`);
        ...
        if (checked) {
          try {
            ...
            if (response.data) {
              ...
              await SecureStore.setItemAsync('registeredData', JSON.stringify(registeredData));
          }
