...
export default function CurrentRideDetails({navigation}) {
...
<View style={styles.container}>
    ...
    <View style={{borderTopWidth:1,borderTopColor:'#D9D9D9',marginHorizontal:'8%'}}>
        <View style={{flexDirection:'row',marginTop:10}}>
            <View style={{width:'50%'}}>
    ...
    <Pressable
            style={({ pressed }) => ({
                ...
                onPress={() => navigation.navigate('cancelOpt')}
            >
